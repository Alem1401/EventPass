...
{
    public class UpdatePerformerDtoValidator : AbstractValidator<UpdatePerformerDto>
    {
        public UpdatePerformerDtoValidator()
        {
            RuleFor(x => x.Name)
            ...
            RuleForEach(x => x.SocialMedia)
                .SetValidator(new UpdateSocialMediaDtoValidator());
